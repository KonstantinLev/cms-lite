...
<head>
    ...
    <link rel="shortcut icon" href="img/favicon.ico?<?=time()?>" type="image/x-icon">
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">CMS Lite base template! (About page)</h1>
                <h2 class="text-center"><a href="index.php">Main page</a> | <a href="about.php">About page</a></h2>
                <ul>
